...
DECLARE @srcInstanceName VARCHAR(100) = 'PBG1SQL01T104.fs.local';
--DECLARE @srcInstanceName VARCHAR(100) = 'EDR1SQL01S821\SOLMAN';
DECLARE @dstInstanceName VARCHAR(100) = 'PBG2SQL01T104.fs.local';
--DECLARE @dstInstanceName VARCHAR(100) = 'EDR1SQL01S820\SOLMAN';

...
-- 2016-03-08	v1.21	LaForest - Correct @backupMediaFamily and @backupMediaSet queries to add DISTINCT keyword
--
ALTER PROCEDURE [dbo].[usp_Restore_Database]
    ...
    @options VARCHAR(128) = 'LISTFULL'  		-- String holding comma separated list of options:
	...
	--			
		...
		--
            WITH    BKStep
                ...
                UPDATE  SBK
                SET     [_backup_step] = BKStep.[_backup_step]
                FROM    @tvBackupSet SBK
